...
**This is the critical phase.** Systematically explore the codebase using available read, search, and shell tools. Do not require Claude-specific Task or Explore tools.

### 3.1 Find Similar Implementations

Search and read files for patterns relevant to: {feature description}
